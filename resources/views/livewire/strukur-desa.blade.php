<section class="px-4 md:px-0 md:w-[80%] 2xl:w-[70%] mt-30 md:mx-auto">
    <!-- Visi Misi Section -->
    <div class="mb-20">        
        <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="bg-white rounded-2xl transition-all duration-300 p-4 md:p-8 border-[1px] border-gray-200 transform hover:-translate-y-1">
                ...
                <blockquote class="text-gray-700 leading-relaxed text-sm md:text-base 2xl:text-lg italic relative">
                    ...
                    <p class="relative z-10 pl-4">{{ $visiMisi->visi }}</p>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-600 mb-2">Belum Ada Data Perangkat</h3>
                    <p class="text-gray-500 text-sm">Data perangkat desa akan segera ditampilkan</p>
                </div>
            @endforelse
        </div>
