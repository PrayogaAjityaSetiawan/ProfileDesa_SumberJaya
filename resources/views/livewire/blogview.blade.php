<div class="md:w-[80%] 2xl:w-[70%] mx-auto px-4 sm:px-6 lg:px-8 mt-30">
        ...
        <div class="bg-white rounded-xl  border border-gray-100 p-6">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('artikel') }}" 
                   wire:navigate
                   class="inline-flex items-center px-4 py-2 {{ !request('categorySlug') ? 'bg-blue-500 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-700' }} rounded-full text-xs sm:text-sm font-medium transition-all duration-200 hover:shadow-md">
                ...
                @foreach ($categories as $category)
                    ...
                    wire:navigate
                    class="inline-flex items-center px-4 py-2 {{ request('categorySlug') === $category->slug ? 'bg-blue-500 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-700' }} rounded-full text-xs sm:text-sm font-medium transition-all duration-200 hover:shadow-md">
                        {{ $category->name }}
